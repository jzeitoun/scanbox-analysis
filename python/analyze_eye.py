...
def analyze_eye(fname,write=0):
	...
	np.save(fname + '_pupil_area',area_trace)
	#np.save(fname + '_raw_xy_position',centroid_trace) # don't need to save this, saving angular velocity instead
	np.save(fname + '_angular_rotation',angular_rotation)
