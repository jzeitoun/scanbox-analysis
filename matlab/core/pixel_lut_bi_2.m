function [S,pIdx,pIdxA,cdIdx,ncol] = pixel_lut_bi_2(nlines,magnification)

global sbconfig;

ncol = 796;
nsamp =  round(sbconfig.lasfreq / 7918); % modified by JZ, original: nsamp =  round(sbconfig.lasfreq / sbconfig.resfreq);
M = ncol+2;
