function crop_sbx2pacu_align_select(fname,alignFile,N)
...
a = 1:200;
for i = 1:200
    x = squeeze(sbxread(alignFile,i,1));
    x = mean(x(:));
    a(i) = x;
end
...
% Set reference image
[~,refIDX] = max(a);
ref = squeeze(sbxread(alignFile,refIDX,1));
...
for i = 1:numChunks
    ...
    parfor j = 1:setIDX
        ...
        img = imhistmatch(img,ref); % correct illumination differences
